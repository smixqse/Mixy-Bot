...
// Isso vai detectar quais são as línguas disponíveis. Copiei de um arquivo. KEKEKEKEKEKE
var langs = {
    'af': 'Afrikaans',
    'sq': 'Albanian',
    'am': 'Amharic',
...
exports.run = (bot, message, args) => {
    if(args.length <= 1) {
        ...
        message.channel.sendMessage('<:vpRedTick:257437215615877129> | Você não deu argumentos corretos. Use o comando de ajuda para ver a sintaxe correta.') }
    } else {
